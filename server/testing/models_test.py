...
class TestPost:
    ...
    def test_content_length(self):
        ...
        with app.app_context():
            ...
            with pytest.raises(ValueError):
                ...
                post2 = Post(
                    title="Guess Why I love programming.",
                    content=content_string2,
                    category="Non-Fiction",
                )
    ...
    def test_summary_length(self):
        ...
        with app.app_context():
            ...
            post1 = Post(
                title="You Won't Believe Why I love programming..",
            ...
            with pytest.raises(ValueError):
                post2 = Post(
                    title="Top Reasons Why I love programming..",
                    content=content_string,
    ...
    def test_category(self):
        ...
        with app.app_context():
            ...
            with pytest.raises(ValueError):
                post = Post(
                    title="Top Ten Reasons I Love Programming.",
                    content=content_string,
                    category="Banana",
                )
